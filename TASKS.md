...
- [ ] **P1-4. Seed fixtures** *(depends on P0-1)*: a fake group chat transcript that plays out the §11 demo narrative, plus the venue/event dataset chosen in P0-1, in `/tests/fixtures`. Fixtures validate against the P1-1 schemas as part of their own test.
...
*Depends on P0-1 (data source decision) and P0-2 (Merge credentials).*
