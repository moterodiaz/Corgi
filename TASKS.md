...
- [x] **P3-4. Plan Synthesis Layer** (§8): prompt combining profiles + retrieved candidates (stub the retrieval call until Phase 4 lands) + current plan object → new versioned `PlanObject` + human-readable rationale. Tests including the versioning behavior on revision.
